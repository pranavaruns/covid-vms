...
<html lang="en">
<head>
<title>Covid Vaccination Management System || View Applied Vaccination</title>
<meta charset="UTF-8" />
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="vaccination-history.php" class="current">View Applied Vaccination</a> </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title">
            ...
            <h5>View Applied Vaccination</h5>
          </div>
...
$sql="SELECT * from tblvaccinationbooking where UserID=:uid";
