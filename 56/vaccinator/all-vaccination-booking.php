...
<html lang="en">
<head>
<title>Covid Vaccination Management System || All Vaccination Request</title>
<meta charset="UTF-8" />
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="all-vaccination-booking.php" class="current">All Vaccination Request</a> </div>
...
$sql="SELECT * from tblvaccinationbooking where VaccineCenterid=:vcenid";
