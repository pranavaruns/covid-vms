...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT ID,VaccinationCenterID FROM tblvaccinator WHERE EmpID=:empid and Password=:password";
...
$_SESSION['cvmsvid']=$result->ID;
$_SESSION['cvmsvcenid']=$result->VaccinationCenterID;
} 
...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tblvaccinator WHERE Email=:email and MobileNumber=:mobile";
$query= $dbh -> prepare($sql);
...
if($query -> rowCount() > 0)
{
$con="update tblvaccinator set Password=:newpassword where Email=:email and MobileNumber=:mobile";
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on"><i class="icon-user"></i></span><input type="text"  placeholder="Enter Employee ID" required="true" name="empid" value="" >
                        </div>
                    </div>
                </div>
                <div class="control-group">
