...
$sql ="SELECT ID FROM tblvaccinator WHERE ID=:vid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tblvaccinator set Password=:newpassword where ID=:vid";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':vid', $vid, PDO::PARAM_STR);
