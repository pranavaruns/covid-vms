...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="manage-vaccine-type.php" class="current">Reports of Vaccination Application</a> </div>
...
$sql="SELECT * from tblvaccinationbooking where VaccineCenterid=:vcenid && date(DateofBooking) between '$fdate' and '$tdate'";
