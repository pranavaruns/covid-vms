...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="reg-users.php" class="current"> Vaccine Requests</a> </div>
    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          ...
          <h3>Vaccination Request By '<?php echo $username;?>'</h3>
          <div class="widget-title">
             <span class="icon"><i class="icon-th"></i></span> 


            <h5>Vaccination Request By <?php echo $username;?></h5>
          </div>
