      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php
                $eid=$_GET['editid'];
$sql="SELECT tblvaccinecenter.ID,tblvaccinecenter.Nameofvaccinecenter,tblvaccinecenter.CenterAddress,tblvaccinecenter.State,tblvaccinecenter.City,tblvaccinecenter.Pincode,tbluser.ID,tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tbluser.RegDate,tblvaccinator.Name as vaccname,tblvaccinator.EmpID, tblvaccinationbooking.* from tblvaccinationbooking 
join tblvaccinecenter on tblvaccinecenter.ID=tblvaccinationbooking.VaccineCenterid 
join tbluser on tbluser.ID=tblvaccinationbooking.UserID 
left join tblvaccinator on tblvaccinator.ID=tblvaccinationbooking.VaccinationDoneby where tblvaccinationbooking.ID=:eid";
