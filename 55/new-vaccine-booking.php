...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="new-vaccine-booking.php" class="current">New Vaccine Request</a> </div>
...
$sql="SELECT * from tblvaccinationbooking where Status is null";
