...
<html lang="en">
<head>
<title>Covid Vaccination Management System || Completed Vaccination</title>
<meta charset="UTF-8" />
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="vaccination-done.php" class="current">Completed Vaccination</a> </div>
...
$sql="SELECT * from tblvaccinationbooking where Status='Vaccinated'";
